...
static const uint16_t BM1370_FREQUENCY_OPTIONS[] = {525, 650, 675, 710, 750, 800, 825, 850, 875, 900, 0};
...
static const uint16_t BM1370_VOLTAGE_OPTIONS[] = {1150, 1200, 1210, 1250, 1275, 1300, 1350,             0};
