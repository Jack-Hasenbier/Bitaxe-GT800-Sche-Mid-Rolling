...
static const uint16_t BM1370_FREQUENCY_OPTIONS[] = {525, 650, 710, 800, 820, 830, 840, 850,           0};
...
static const uint16_t BM1370_VOLTAGE_OPTIONS[] = {1150, 1200, 1250,                   0};
...
static const AsicConfig ASIC_BM1370 = { .id = BM1370, .name = "BM1370", .chip_id = 1370, .default_frequency_mhz = 800, .frequency_options = BM1370_FREQUENCY_OPTIONS, .default_voltage_mv = 1200, .voltage_options = BM1370_VOLTAGE_OPTIONS, .difficulty = 256, .core_count = 128, .small_core_count = 2040, .hash_domains = 4, .hashrate_test_percentage_target = 0.85, };
